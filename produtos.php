        ...
        <div class="menu">
            ...
            <ul class="item-menu">
               <!-- <li><a href="#home" class="nav-link">Home</a></li>-->
                <li><a href="gerente.php#pesquisa" class="nav-link">Pedidos</a></li>
                <li><a href="produtos.php" class="nav-link">Produtos</a></li>
                <li><a href="gerente.php#area-contato" class="nav-link">Contato</a></li>
        ...
        <div class="mobile-menu">
            <ul>
               <!-- <li class="nav-item" ><a href="#home" class="nav-link">Home</a></li>-->
                <li class="nav-item"><a href="gerente.php#pesquisa" class="nav-link">Pedidos</a></li>
                <li class="nav-item"><a href="produtos.php" class="nav-link">Produtos</a></li>
                <li class="nav-item"><a href="gerente.php#area-contato" class="nav-link">Contato</a></li>
                <li class="nav-item"><a href="logout.php" class="nav-link-bnt">Sair</a></li>
            </ul>
        </div>
    </header>

    <section class="pesquisa" id ="pes-produto">
    <div class='boxsearch'>
